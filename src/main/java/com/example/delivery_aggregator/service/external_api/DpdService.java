...
public class DpdService {
    ...
    /*Не задано значение для параметра "Контактное лицо получателя"
Не задано значение для параметра "Контактный телефон получателя"
Не задано значение для параметра "Название получателя"
ORA-20815: Улица с названием  “Улица” неизвестна.
ORA-20799: p_req_address_contact_id is null and p_client_address_code is null and p_regular_num is null*/
}
